...
if ( ! class_exists( 'TGMOP_Plugin_Activation' ) ) {
	...
	if ( ! function_exists( 'load_tgm_plugin_activation' ) ) {
		...
		function load_tgm_plugin_activation() {
			$GLOBALS['tgmpa'] = TGMOP_Plugin_Activation::get_instance();
		}
	}
...
if ( ! function_exists( 'op_tgmpa' ) ) {
	 ...
	 */
	function op_tgmpa( $plugins, $config = array() ) {
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		protected function _get_plugin_data_from_name( $name, $data = 'slug' ) {
			_deprecated_function( __FUNCTION__, 'TGMPA 2.5.0', 'TGMOP_Plugin_Activation::_get_plugin_data_from_name()' );
